...
import { LayoutDashboard, CreditCard, Code } from 'lucide-react';

export function CustomerLayout() {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const navItems = [
    { label: 'Dashboard', path: '/customer', icon: LayoutDashboard },
    { label: 'Subscription', path: '/customer/subscription', icon: CreditCard },
    { label: 'API Integration', path: '/customer/api', icon: Code },
  ];
